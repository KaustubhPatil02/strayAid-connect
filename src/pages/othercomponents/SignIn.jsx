...
export function SignIn() {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    // Replace 'admin' and 'password' with your predefined username and password
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        <div className="relative flex items-end px-4 pb-10 pt-60 sm:px-6 sm:pb-16 md:justify-center lg:px-8 lg:pb-24">
          <div className="absolute inset-0">
            {/* <br /> */}
            <img
              className="h-full w-full rounded-md object-cover object-top space-x-1 space-y-2"
              src="https://daoinsights.com/wp-content/uploads/2022/03/anoir-chafik-2_3c4dIFYFU-unsplash.jpg"
              alt=""
            />
          </div>
        ...
        <div className="flex items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-24">
          <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
            <h2 className="text-3xl font-bold leading-tight text-black sm:text-4xl">Welcome Admin</h2>
            ...
            <form action="#" method="POST" className="mt-8" onClick={handleLogin}>
