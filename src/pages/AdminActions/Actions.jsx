...
export function Actions() {
    ...
    const databaseURL = 'https://strayaid-connect-default-rtdb.firebaseio.com/landingPage-Reporting.json';
    ...
    <>
      <section className="mx-auto w-full max-w-7xl px-4 py-4">
        <div className="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0">
          <div>
            <h2 className="text-lg font-semibold">Reporting Data</h2>
                  ...
                  <tbody className="divide-y divide-gray-200 bg-white">
                    {peopleData.map((person, index) => (
                      <tr key={index} className="divide-x divide-gray-200">
                        ...
                        <td className="px-4 py-4 text-sm text-gray-500 overflow-auto">
  {person.msg}
</td>
