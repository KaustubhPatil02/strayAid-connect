      ...
      <div className="mx-auto max-w-5xl px-5 py-24">
        <div className="mx-auto flex flex-wrap items-center lg:w-4/5">
          <img
            ...
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSX9GFvIN8NrkElgYjhUImtC0HduLATVPhcMHATVBon7wQ3tzztEjzazF3M-maTN0uCp0I&usqp=CAU" // src="https://dogwithblog.in/wp-content/uploads/2019/09/mumbai-dog-helpline.jpg"
          />
          <div className="mt-6 w-full lg:mt-0 lg:w-1/2 lg:pl-10">
            <h2 className="text-sm font-semibold tracking-widest text-gray-500"></h2>
            <h1 className="my-4 text-3xl font-semibold text-black">Harry</h1>
