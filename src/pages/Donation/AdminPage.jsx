...
const AdminPage = () => {
  ...
  <button className="self-end px-4 py-2 mt-4 bg-red-500 text-white rounded hover:bg-red-700 mr-4" onClick={handleLogout}>Logout</button>
  <Link to="/actions" className="inline-block bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded mr-4">
    Reports
  </Link>
  <Link to="/volunteers" className="inline-block bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
    Volunteers Data
  </Link>
</div>
      <DonationPage />
